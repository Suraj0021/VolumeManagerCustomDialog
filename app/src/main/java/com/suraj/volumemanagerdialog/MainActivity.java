package com.suraj.volumemanagerdialog;
...
//            VolumeEditorDialog volumeEditorDialog = new VolumeEditorDialog(MainActivity.this);
...
//            volumeEditorDialog.show();
        ...
        private class VolumeEditorDialogInterface implements VolumeEditorDialog.VolumeDialogInterface {
            ...
            public void seekMediaData(int mediaValue) {
                ...
                if (mediaValue <= 70 && mediaValue>30)mediaLayout.setBackgroundColor(getResources().getColor(R.color.Green));
